...
class Theme_Includes {
	...
	public static function init() {
		 ...
		 */
		{
			...
			self::include_child_first( '/actions.php' );
...
//			self::include_child_first('/template-functions.php');
		...
		if ( ! is_admin() ) {
			...
			add_action( 'admin_enqueue_scripts', array( __CLASS__, '_action_enqueue_scripts_backend' ),
				20 // Include later to be able to make wp_dequeue_style|script()
			);
		}
	}
	 ...
	 * Backend script
	 */
	public static function _action_enqueue_scripts_backend() {
